...
namespace TwentyOne
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!validAnswer)
            {
                Console.WriteLine("Thank you, {0}. And how much money did you bring today?", playerName);
                validAnswer = int.TryParse(Console.ReadLine(), out bank);
                if (!validAnswer) Console.WriteLine("Please enter whole numbers only.");
            }

            Console.WriteLine("Wonderful, {0}. Would you like to join a game of 21 right now?", playerName);
            ...
            Console.WriteLine("Feel free to look around the casino. Hope to see you again soon!");
            Console.ReadLine();
        }
